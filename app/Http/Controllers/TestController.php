    ...
    public function getMovie()
    {
        ...
        foreach ($links as $link){
            ...
            if (substr($current_link,0,3) == '/m/'){
                ...
                $movie->name = $movie_title->textContent;
        ...
        /*
        $links = $movie_table->getElementsByTagName('a');
        ...
        foreach ($links as $link){
            ...
            if (substr($current_link,0,3) == '/m/'){
                $curr_movie_url = 'https://www.rottentomatoes.com'.$current_link;
                echo $curr_movie_url . '<br>';


                $movie_html = $this->sendGetRequest($curr_movie_url);
                @$dom->loadHTML($movie_html);

                $movie_title = $dom->getElementById('movie-title');
                echo $movie_title->textContent . "<br>";
                if($count > 10) break;
